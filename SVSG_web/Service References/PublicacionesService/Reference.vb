...
Namespace PublicacionesService
    
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute(ConfigurationName:="PublicacionesService.IListado")>  _
    ...
    Public Interface IListadoChannel
        Inherits PublicacionesService.IListado, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>  _
    Partial Public Class ListadoClient
        Inherits System.ServiceModel.ClientBase(Of PublicacionesService.IListado)
        Implements PublicacionesService.IListado
        ...
        Public Function cargarLista(ByVal tipo_doc As String, ByVal seccion As String, ByVal vigencia As String) As SVSG_lib.Publicaciones Implements PublicacionesService.IListado.cargarLista
            Return MyBase.Channel.cargarLista(tipo_doc, seccion, vigencia)
        End Function
        
        Public Function crearDocumento(ByVal publicacion As SVSG_lib.Publicacion) As Boolean Implements PublicacionesService.IListado.crearDocumento
            Return MyBase.Channel.crearDocumento(publicacion)
        End Function
        
        Public Function modificacionMenor(ByVal publicacion As SVSG_lib.Publicacion, ByVal cod_original As String, ByVal version_original As String) As Boolean Implements PublicacionesService.IListado.modificacionMenor
            Return MyBase.Channel.modificacionMenor(publicacion, cod_original, version_original)
        End Function
        
        Public Function publicacionMayor(ByVal publicacion As SVSG_lib.Publicacion) As Boolean Implements PublicacionesService.IListado.publicacionMayor
            Return MyBase.Channel.publicacionMayor(publicacion)
        End Function
        
        Public Function cargarItem(ByVal cod As String) As SVSG_lib.Documento Implements PublicacionesService.IListado.cargarItem
            Return MyBase.Channel.cargarItem(cod)
        End Function
        
        Public Function eliminar(ByVal cod As String, ByVal ver As String) As Boolean Implements PublicacionesService.IListado.eliminar
